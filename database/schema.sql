...
CREATE TABLE IF NOT EXISTS books (
  ...
  link        VARCHAR(500)  DEFAULT NULL COMMENT 'URL de Google Drive o ruta /uploads/pdfs/archivo.pdf',
  cover       VARCHAR(500)  DEFAULT NULL COMMENT 'Ruta local /uploads/imagen.jpg',
...
INSERT INTO books (title, author, category, year, description, link, color, available, featured) VALUES
